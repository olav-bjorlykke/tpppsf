...
class GlobalParameters:
    ...
    smolt_deployment_upper_bound = 200000 #Upper bound for smolt deployed
    smolt_deployment_lower_bound = 5000 #Lower bound of smolt deployed
    max_harvest = 2000 #Max biomass that can be harvested in any period in tons
    min_harvest = 100 #Minimum amount of biomass that can be harvested if biomass is harvested in tons
    ...
    MAB_site_limit = 1000 #TODO: This is a placeholder, get the real thing from the site datastructure
